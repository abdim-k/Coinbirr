...
class WithdrawInfo {
  ...
  WithdrawInfo.fromJson(dynamic json) {
    _id = json['id'];
    _userId = int.tryParse(json['user_id'].toString()) ?? 0;

    _methodId = int.tryParse(json['method_id'].toString()) ?? 0;

    _currencyConvertId =
        int.tryParse(json['currency_convert_id'].toString()) ?? 0;

    _coins = int.tryParse(json['coins'].toString()) ?? 0;

    _account = json['account'];
    _amount = double.tryParse(json['amount'].toString()) ?? 0.0;

    _approveStatus = int.tryParse(json['approve_status'].toString()) ?? 0;
...
class CurrencyConvert {
  ...
  CurrencyConvert.fromJson(dynamic json) {
    _id = json['id'];
    _currencyId = int.tryParse(json['currency_id'].toString()) ?? 0;

    _parCurrency = int.tryParse(json['par_currency'].toString()) ?? 0;
...
class Currency {
  ...
  Currency.fromJson(dynamic json) {
    ...
    _default = int.tryParse(json['default'].toString()) ?? 0;
...
class WithdrawMethods {
  ...
  WithdrawMethods.fromJson(dynamic json) {
    _id = json['id'];
    _name = json['name'];
    _minimumAmount = int.tryParse(json['minimum_amount'].toString()) ?? 0;
