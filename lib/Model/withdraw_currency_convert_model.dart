...
class CurrencyConvertInfo {
  ...
  CurrencyConvertInfo.fromJson(dynamic json) {
    id = json['id'];
    currencyId = int.parse(json['currency_id'].toString());
    parCurrency = double.parse(json['par_currency'].toString());
    coin = json['coin'];

    String statusString = json['status'].toString().trim();
    status = int.tryParse(statusString) ?? 0;
...
class Currency {
  ...
  Currency.fromJson(dynamic json) {
    ...
    String statusString = json['status'].toString().trim();
    status = double.tryParse(statusString)?.toInt() ?? 0;
